...
/**
 * Unit test class for the GetMessagesOptions model.
 */
public class GetMessagesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetMessagesOptions() throws Throwable {
    GetMessagesOptions getMessagesOptionsModel = new GetMessagesOptions();
    assertNotNull(getMessagesOptionsModel);
  }
}