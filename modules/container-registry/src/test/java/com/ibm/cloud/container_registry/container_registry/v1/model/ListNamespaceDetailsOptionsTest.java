...
/**
 * Unit test class for the ListNamespaceDetailsOptions model.
 */
public class ListNamespaceDetailsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListNamespaceDetailsOptions() throws Throwable {
    ListNamespaceDetailsOptions listNamespaceDetailsOptionsModel = new ListNamespaceDetailsOptions();
    assertNotNull(listNamespaceDetailsOptionsModel);
  }
}