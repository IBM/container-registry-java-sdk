...
/**
 * Unit test class for the GetPlansOptions model.
 */
public class GetPlansOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetPlansOptions() throws Throwable {
    GetPlansOptions getPlansOptionsModel = new GetPlansOptions();
    assertNotNull(getPlansOptionsModel);
  }
}