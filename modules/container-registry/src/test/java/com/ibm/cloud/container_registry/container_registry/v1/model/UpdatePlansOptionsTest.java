...
/**
 * Unit test class for the UpdatePlansOptions model.
 */
public class UpdatePlansOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdatePlansOptions() throws Throwable {
    UpdatePlansOptions updatePlansOptionsModel = new UpdatePlansOptions.Builder()
      .plan("testString")
      .build();
    assertEquals(updatePlansOptionsModel.plan(), "testString");
  }
}