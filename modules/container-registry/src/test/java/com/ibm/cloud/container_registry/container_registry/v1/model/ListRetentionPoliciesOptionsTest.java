...
/**
 * Unit test class for the ListRetentionPoliciesOptions model.
 */
public class ListRetentionPoliciesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListRetentionPoliciesOptions() throws Throwable {
    ListRetentionPoliciesOptions listRetentionPoliciesOptionsModel = new ListRetentionPoliciesOptions();
    assertNotNull(listRetentionPoliciesOptionsModel);
  }
}