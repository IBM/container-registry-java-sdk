...
/**
 * Unit test class for the GetQuotaOptions model.
 */
public class GetQuotaOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetQuotaOptions() throws Throwable {
    GetQuotaOptions getQuotaOptionsModel = new GetQuotaOptions();
    assertNotNull(getQuotaOptionsModel);
  }
}