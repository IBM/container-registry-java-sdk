...
/**
 * Unit test class for the GetAuthOptions model.
 */
public class GetAuthOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetAuthOptions() throws Throwable {
    GetAuthOptions getAuthOptionsModel = new GetAuthOptions();
    assertNotNull(getAuthOptionsModel);
  }
}