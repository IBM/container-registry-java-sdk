...
/**
 * Unit test class for the UpdateQuotaOptions model.
 */
public class UpdateQuotaOptionsTest {
  ...
  public void testUpdateQuotaOptions() throws Throwable {
    UpdateQuotaOptions updateQuotaOptionsModel = new UpdateQuotaOptions.Builder()
      ...
      .trafficMegabytes(Long.valueOf("26"))
      .build();
    assertEquals(updateQuotaOptionsModel.storageMegabytes(), Long.valueOf("26"));
    assertEquals(updateQuotaOptionsModel.trafficMegabytes(), Long.valueOf("26"));
  }
}