...
/**
 * Unit test class for the Quota model.
 */
public class QuotaTest {
  ...
  @Test
  public void testQuota() throws Throwable {
    Quota quotaModel = new Quota();
    assertNull(quotaModel.getLimit());
    assertNull(quotaModel.getUsage());
  }
}