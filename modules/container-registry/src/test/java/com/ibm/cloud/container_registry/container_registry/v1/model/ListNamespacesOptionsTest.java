...
/**
 * Unit test class for the ListNamespacesOptions model.
 */
public class ListNamespacesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListNamespacesOptions() throws Throwable {
    ListNamespacesOptions listNamespacesOptionsModel = new ListNamespacesOptions();
    assertNotNull(listNamespacesOptionsModel);
  }
}