...
/**
 * Unit test class for the ListDeletedImagesOptions model.
 */
public class ListDeletedImagesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListDeletedImagesOptions() throws Throwable {
    ListDeletedImagesOptions listDeletedImagesOptionsModel = new ListDeletedImagesOptions.Builder()
      .namespace("testString")
      .build();
    assertEquals(listDeletedImagesOptionsModel.namespace(), "testString");
  }
}