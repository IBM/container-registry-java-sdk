...
public class AnalyzeRetentionPolicyOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Builds a AnalyzeRetentionPolicyOptions.
     *
     * @return the new AnalyzeRetentionPolicyOptions instance
     */
     ...
     *
     * @param namespace the namespace
     * @return the AnalyzeRetentionPolicyOptions builder
     */
   ...
   * New builder.
   *
   * @return a AnalyzeRetentionPolicyOptions builder
   */
