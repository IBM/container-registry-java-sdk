...
public class RestoreTagsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing RestoreTagsOptions instance.
     *
     * @param restoreTagsOptions the instance to initialize the Builder with
     */
