...
# IBM Cloud Container Registry Java SDK Version 1.1.4
...
--- | ---
[Container Registry image management API](https://cloud.ibm.com/apidocs/container-registry) | com.ibm.cloud:container-registry:1.1.4
[Container Registry Vulnerability Advisor API](https://cloud.ibm.com/apidocs/container-registry/va-v4) | com.ibm.cloud:vulnerability-advisor:1.1.4
...
### Gradle
```gradle
'com.ibm.cloud:container-registry:1.1.4'
'com.ibm.cloud:vulnerability-advisor:1.1.4'
```
