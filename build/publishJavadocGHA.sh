...
git clone --branch=gh-pages https://x-access-token:${GITHUB_TOKEN}@github.com/${GH_REPO_SLUG}.git gh-pages

printf "\n>>>>> Finished cloning...\n"

pushd gh-pages

# Create a new directory for this tag and copy the javadocs there.
